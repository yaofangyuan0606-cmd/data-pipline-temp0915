...
- [SAM 分割质量评估](docs/SAM_ASSESSMENT.md) — 50 张 H01 切片上的实测：160nm 粗细是硬门槛、失败是「没画」而非「画错」、漏检占修复成本 93.7%、该怎么用与不该怎么用
- [切片填色技术方案与交付说明](docs/FILL_METHOD.md) — 填色三层实现、六个工具的算法、SAM 预填后的推荐流程、结果取回方式与实测数字

...
(() => {
  ...
  async function goZ(z, keepHover, force = false) {
    ...
    if (z !== S.z) { if (S.ngMode) setTool("pick"); mergeArm(null); clearSAM(); clearRepair(); }
    const block = S.block;
